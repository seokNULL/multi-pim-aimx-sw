...
int main(int argc, char *argv[])
{
    ...
    for(size_t i=0; i<PMM_SIZE/8; i++){
      unsigned long long tmp  = 0x3f803f803f803f80;
      pmm_va[i] = tmp;
    }
  #endif
    ...
    for(size_t i=0; i<srcA_size; i++){
      ...
      // float constant_value  = i;
      float constant_value  = 1;
      // random_value  = i;
      // float constant_value  = i;
      // float constant_value  = 0.25;
      short tmp0 = float_to_short(random_value);
    ...
    float constant_value = -1;
    for(size_t i=0; i<srcB_size; i++){
      random_value  = generate_random_255();
      // constant_value  = 0;
      constant_value  = 2;
      // constant_value  = (i%16 == 0) ? 0 : constant_value+1;
      // float random_value  = 256;
      // short tmp0 = float_to_short(constant_value);
      short tmp0 = float_to_short(random_value);
      PL_srcB_buf[i]=tmp0;
