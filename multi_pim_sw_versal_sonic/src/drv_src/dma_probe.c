...
//         }
        ...
        cdma_dev->dma_ctl_reg = ioremap(dma_start, dma_len); // ioremap is default nocached - recent version of kernel
        ...
        cdma_dev->config_reg = ioremap(mem_start + CONF_REG_OFFSET, CONF_REG_LEN); 
        ...
        cdma_dev->config_mem = ioremap(mem_start + CONF_MEM_OFFSET, CONF_MEM_LEN);
        ...
        */
        ...
        switch (CH_NUM) {
            case 1:  iowrite32(CHROCOBA, pim_mem_addr_map + PCI_ADDR_MAP_WR);  break; //1Ch.
            case 2:  iowrite32(ROCOBACH2, pim_mem_addr_map + PCI_ADDR_MAP_WR); break; //2Ch.
            case 4:  iowrite32(ROCOBACH4, pim_mem_addr_map + PCI_ADDR_MAP_WR); break; //4Ch.
            case 8:  iowrite32(ROCOBACH8, pim_mem_addr_map + PCI_ADDR_MAP_WR); break; //8Ch.
            case 16: iowrite32(ROCOBACH, pim_mem_addr_map + PCI_ADDR_MAP_WR);  break; //16Ch.
            default: iowrite32(CHROCOBA, pim_mem_addr_map + PCI_ADDR_MAP_WR);  break; //1Ch.
        }
