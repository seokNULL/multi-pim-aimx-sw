...
/* Multi-Channel CL size */
#define CLP
// #define CL_SET_OFFSET              0x3000 
// #define CL_SET_OFFSET              0x6F00 
#define CL_SET_OFFSET              0x00800000 
#define CLP
#define CH_NUM 16
#define AIMX_SPIM_CH_NUM CH_NUM
// #define CODE_OVER_8MB
#define PMM
#define PMM_SIZE    0x30000
#define VECA_OFFSET 0x0
#define VACC_OFFSET 0x10000
#define HPC_OFFSET  0x20000
#define WR_REG  0x1
#define RD_REG  0x0

#define CLUSTER_SIZE 8
#define BATCH_SIZE 8
#define B_CHUNK CLUSTER_SIZE/BATCH_SIZE
#define MAX_BATCH 1
#define REG_CHUNK 256
...
extern int pmm_access(pim_args *pim_args);
extern void set_piu_base_addr(uint64_t pmm_base_addr);

/* CDMA data copy */
extern int internalMemcpy(void *pim_dst, void *pim_src, int size, int fpga_id);
#ifdef CLP
extern int CLinternalMemcpy(void *pim_dst, void *pim_src, int size, int fpga_id, uint32_t cl_size);
// extern int CLinternalMemcpy(void *pim_dst, void *pim_src, int size, int fpga_id, cl_data_t cl_data);
#endif
...
extern int datacopy_pim2pim(void *pim_dst, const void *pim_src, int size, int dst_id, int src_id);
extern int datacopy_desclist(const void *cpu_src, int size, int fpga_id);
